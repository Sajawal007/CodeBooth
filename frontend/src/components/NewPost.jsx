        ...
        <div className="container flex flex-row m-5 rounded-md border border-solid" style={{backgroundImage:"url(\"email.svg\")"}}>
            <div className="inner-container">
                ...
                <div className="flex flex-col pl-5 pb-5">
                    <input className="font-bold text-white rounded-lg bg-fav_blue-100 border-solid border-2 border-offwhite-100 mb-3" style={titleInput} placeholder="Enter Title" onChange={(e)=>setTitle(e.target.value)}/>
                    <input className="rounded-lg text-offwhite-100 bg-fav_blue-100 border-solid border-2 border-white mb-3" style={newPostStyle} placeholder="Explain Briefly" onChange={(e)=>setContent(e.target.value)}/>
